...
( I've got 500 Unicorn eggs. Up West they'll charge you £1m each, I can let you have them for a 'pony' a piece or 5 for a 'monkey'...guaranteed to turn base metal into pure gold..cash only......................eggs may be gold painted duck eggs, buyer beware, only for holders of Blue Passports..it's the will of the people, innit)`,
      ...
      timestamp: new Date(2018, 5, 27, 22, 47),
      numUpVotes: 1,
      numDownVotes: 0,
    ...
    },
    {
      ...
      timestamp: new Date(2018, 5, 27, 20, 0),
      numUpVotes: 1,
      numDownVotes: 0,
      replies: [],
    },
...
We want to see all business thrive but most of this noise is from large corporations. Also remember out of 26m employed in UK 22m are employed by SME's or the public sector`,
      timestamp: new Date(2018, 5, 27, 17, 33),
      numUpVotes: 6,
      numDownVotes: 0,
      replies: [
        {
...
All that the Withdrawal Act does is to define what happens when we leave. It doesn't make us any more or less likely to leave.`,
    ...
    //     },
    {
      ...
      timestamp: new Date(2018, 5, 27, 16, 35),
      numUpVotes: 1,
      numDownVotes: 2,
      replies: [
        {
...
Next time, he might even use a capital letter.`,
    ...
    // },
    {
      ...
      timestamp: new Date(2018, 5, 27, 16, 27),
      numUpVotes: 1,
      numDownVotes: 2,
      replies: [],
    },
...
.`,
      timestamp: new Date(2018, 5, 27, 16, 8),
      numUpVotes: 3,
      numDownVotes: 4,
      replies: [],
    },
    {
      ...
      timestamp: new Date(2018, 5, 27, 15, 56),
      numUpVotes: 3,
      numDownVotes: 2,
      replies: [],
    },
...
Watch and learn`,
      timestamp: new Date(2018, 5, 27, 15, 52),
      numUpVotes: 4,
      numDownVotes: 3,
      replies: [],
    },
...
:-)`,
      timestamp: new Date(2018, 5, 27, 15, 44),
      numUpVotes: 4,
      numDownVotes: 3,
      replies: [],
    },
...
Problem here is that you and longmemory can not debate Brexit. That is the big issue.`,
      timestamp: new Date(2018, 5, 27, 14, 52),
      numUpVotes: 1,
      numDownVotes: 1,
      replies: [
        {
...
A: Yes but only with the help of the Ulster DUP.`,
      timestamp: new Date(2018, 5, 27, 14, 48),
      numUpVotes: 0,
      numDownVotes: 1,
      replies: [],
    },
...
Thank you.`,
      timestamp: new Date(2018, 5, 27, 14, 43),
      numUpVotes: 0,
      numDownVotes: 0,
      replies: [
        {
...
Are you listening Nissan?`,
      timestamp: new Date(2018, 5, 27, 14, 29),
      numUpVotes: 0,
      numDownVotes: 0,
      replies: [],
    },
    {
      id: 18,
      displayName: 'Tom Waller',
      commentText: `As long as the 15.2 Million people who live in England and voted Brexit do not see the fact that the referendum was not democratic and a 2% majority should never of been acted on the Union of Great Britain will not survive this.

The people of Scotland are far enough north of the major markets as it is without Brexit is making it a LOT worse.

Save the Union and remain in the EU England!`,
      timestamp: new Date(2018, 5, 27, 14, 23),
      numUpVotes: 1,
      numDownVotes: 1,
      replies: [],
    },
