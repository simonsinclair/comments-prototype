...
His use of a profanity to describe all British employers, if done my any other minister would have resulted in immediate dismissal - so why hasn't Maysy sacked him - perhaps she shares his opinion that all British workers should lose their employment - LIKE BORIS.

May's Tory party is a dead man walking - with no standards or integrity.

Kick out Boris.`,
      timestamp: new Date(2018, 5, 26, 12, 3),
      numUpVotes: 6,
      numDownVotes: 0,
      replies: [],
    },
    ...
    },
    {
      ...
      timestamp: new Date(2018, 5, 26, 12, 47),
      numUpVotes: 1,
      numDownVotes: 0,
...
Start of a trend?`,
      timestamp: new Date(2018, 5, 26, 13, 0),
      numUpVotes: 1,
      numDownVotes: 0,
      replies: [],
    },
    {
      ...
      timestamp: new Date(2018, 5, 26, 15, 33),
      numUpVotes: 6,
      numDownVotes: 0,
      replies: [],
    },
    {
      ...
      timestamp: new Date(2018, 5, 26, 16, 35),
      numUpVotes: 1,
      numDownVotes: 2,
      replies: [],
    },
...
All in a day when British assets lose more and more and more value.

Still, Brexitear Odey will be enjoying his £200 Million profits betting against Intu I imagine.

:)`,
      timestamp: new Date(2018, 5, 27, 16, 20),
      numUpVotes: 1,
      numDownVotes: 2,
      replies: [],
    },
...
We all know the type of UK they want and it's not one the vast majority do. Orwellian times will truly be on us if we give up and let them take over the news! `,
      timestamp: new Date(2018, 5, 27, 16, 21),
      numUpVotes: 4,
      numDownVotes: 3,
      replies: [],
    },
...
Integration is why Scotland and England trade so freely.

That same integration that is the freedom of movement and free trade area which is the EU and Europe.

Scotland, Ireland and Gibraltar support staying in the EU.

Guess what England. Nothing but troubles ahead. Did warn you 2 years ago to Exit Brexit.`,
      timestamp: new Date(2018, 6, 1, 11, 18),
      numUpVotes: 3,
      numDownVotes: 4,
      replies: [],
    },
...
:-) `,
      timestamp: new Date(2018, 6, 1, 15, 44),
      numUpVotes: 3,
      numDownVotes: 2,
      replies: [],
    },
...
Watch and learn`,
      timestamp: new Date(2018, 6, 1, 15, 52),
      numUpVotes: 4,
      numDownVotes: 3,
      replies: [],
    },
...
We will stop paying for Romanian motorways soon.
The foreign Remoaners on here pretending to be British do provide plenty of amusement though, and I can’t wait until March 2019.`,
      timestamp: new Date(2018, 6, 2, 10, 21),
      numUpVotes: 4,
      numDownVotes: 3,
      replies: [
        {
          ...
          timestamp: new Date(2018, 6, 2, 11, 32),
          numUpVotes: 0,
          numDownVotes: 0,
        },
        {
...
That is a fact England/Westminster best not ignore.`,
...
NOR was turning down Scotland's request to hold the 2016 referendum to EU Majority rule where 3 out of 4 of the member states of the UK would have to vote for Brexit.`,
          timestamp: new Date(2018, 6, 2, 13, 50),
          numUpVotes: 0,
          numDownVotes: 0,
        },
        {
...
It’s 50-50 whether she will. Tory/lab voter numbers are finely balanced

We need a disruption tactic to work. Scotland/NI is a good bet, so is People’s Vote, there are many others

It needs only one to work to save UK.`,
          timestamp: new Date(2018, 6, 2, 13, 52),
          numUpVotes: 0,
          numDownVotes: 0,
        },
        {
...
`,
          timestamp: new Date(2018, 6, 2, 14, 30),
          numUpVotes: 0,
          numDownVotes: 0,
        },
        {
...
"A network of Yes groups all across Scotland has begun to regroup and reform. I was sent a list of more than 150 of them and this was by no means complete. This time, they will be demanding more autonomy from SNP central control over independence"`,
          timestamp: new Date(2018, 6, 2, 14, 43),
          numUpVotes: 0,
          numDownVotes: 0,
        },
      ],
    },
    {
      ...
      timestamp: new Date(2018, 6, 2, 11, 8),
      numUpVotes: 1,
      numDownVotes: 1,
      replies: [],
    },
...
Yes we will end up without leaving, and the UK will suffer from remaining in all the costs and rules as it has for 40 year`,
          timestamp: new Date(2018, 6, 2, 13, 21),
          numUpVotes: 0,
          numDownVotes: 0,
        },
        {
          ...
          timestamp: new Date(2018, 6, 2, 14, 40),
          numUpVotes: 0,
          numDownVotes: 0,
        },
        {
...
Our message to government is that until it can demonstrate exactly how a new model for customs and trade with the EU can replicate the benefits we currently enjoy, don't change it."`,
          timestamp: new Date(2018, 6, 2, 14, 42),
          numUpVotes: 0,
          numDownVotes: 0,
        },
        {
...
( I've got 500 Unicorn eggs. Up West they'll charge you £1m each, I can let you have them for a 'pony' a piece or 5 for a 'monkey'...guaranteed to turn base metal into pure gold..cash only......................eggs may be gold painted duck eggs, buyer beware, only for holders of Blue Passports..it's the will of the people, innit)`,
          timestamp: new Date(2018, 6, 2, 14, 53),
          numUpVotes: 0,
          numDownVotes: 0,
        },
        {
...
We want to see all business thrive but most of this noise is from large corporations. Also remember out of 26m employed in UK 22m are employed by SME's or the public sector`,
      timestamp: new Date(2018, 6, 2, 15, 0),
      numUpVotes: 1,
      numDownVotes: 1,
      replies: [],
    },
